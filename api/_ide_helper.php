 ...
 * Generated for Laravel 5.3.28 on 2017-01-21.
 *
...
namespace {
    ...
    class ArticleFile extends \Illuminate\Support\Facades\File{
    ...
    class Queue extends \Illuminate\Support\Facades\Queue{
        ...
        public static function size($queue = null){
            return \VladimirYuldashev\LaravelQueueRabbitMQ\Queue\RabbitMQQueue::size($queue);
        }
        ...
        public static function push($job, $data = '', $queue = null){
            return \VladimirYuldashev\LaravelQueueRabbitMQ\Queue\RabbitMQQueue::push($job, $data, $queue);
        }
        ...
        public static function pushRaw($payload, $queue = null, $options = array()){
            return \VladimirYuldashev\LaravelQueueRabbitMQ\Queue\RabbitMQQueue::pushRaw($payload, $queue, $options);
        }
        ...
        public static function later($delay, $job, $data = '', $queue = null){
            return \VladimirYuldashev\LaravelQueueRabbitMQ\Queue\RabbitMQQueue::later($delay, $job, $data, $queue);
        }
        ...
        public static function pop($queue = null){
            return \VladimirYuldashev\LaravelQueueRabbitMQ\Queue\RabbitMQQueue::pop($queue);
        }
         ...
         * @static 
         */
        public static function setAttempts($count){
            \VladimirYuldashev\LaravelQueueRabbitMQ\Queue\RabbitMQQueue::setAttempts($count);
        }
        ...
        public static function setCorrelationId($id){
            \VladimirYuldashev\LaravelQueueRabbitMQ\Queue\RabbitMQQueue::setCorrelationId($id);
        }
        ...
        public static function getCorrelationId(){
            return \VladimirYuldashev\LaravelQueueRabbitMQ\Queue\RabbitMQQueue::getCorrelationId();
        }
        ...
        public static function pushOn($queue, $job, $data = ''){
            ...
            return \VladimirYuldashev\LaravelQueueRabbitMQ\Queue\RabbitMQQueue::pushOn($queue, $job, $data);
        }
        ...
        public static function laterOn($queue, $delay, $job, $data = ''){
            //Method inherited from \Illuminate\Queue\Queue            
            return \VladimirYuldashev\LaravelQueueRabbitMQ\Queue\RabbitMQQueue::laterOn($queue, $delay, $job, $data);
        }
        ...
        public static function bulk($jobs, $data = '', $queue = null){
            //Method inherited from \Illuminate\Queue\Queue            
            return \VladimirYuldashev\LaravelQueueRabbitMQ\Queue\RabbitMQQueue::bulk($jobs, $data, $queue);
        }
        ...
        public static function setContainer($container){
            //Method inherited from \Illuminate\Queue\Queue            
            \VladimirYuldashev\LaravelQueueRabbitMQ\Queue\RabbitMQQueue::setContainer($container);
        }
